module csort.ru/auth-service

go 1.25.5

require (
	github.com/CsortTeam/envkeys v0.1.0
	...
	github.com/intility/go-jwks v1.11.1
	github.com/jackc/pgx/v5 v5.9.2
	github.com/joho/godotenv v1.5.1
	github.com/kxrxh/gopt v0.0.0-20260212165454-e6ed7b687f5f
